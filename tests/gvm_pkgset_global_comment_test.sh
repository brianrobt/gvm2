...
cat > "$GVM_ROOT/environments/duptest" <<EOF
export GVM_ROOT; GVM_ROOT="$GVM_ROOT"
export gvm_go_name; gvm_go_name="duptest"
export gvm_pkgset_name; gvm_pkgset_name="global"
export GOPATH; GOPATH="$GVM_ROOT/pkgsets/duptest/global"
export PATH; PATH="$GVM_ROOT/pkgsets/duptest/global/bin:\$PATH"
EOF
